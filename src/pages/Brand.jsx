...
import SearchBrandsPrice from "../components/SearchBrandsPrice";
...
function Brand() {
  ...
  const getValue = async () => {
    if (!mode) {
      fetch(
        `https://students.trungthanhweb.com/api/getBrandProducts?apitoken=${token}&${queryString.stringify(
          queryParams
        )}`
      )
        .then((res) => res.json())
    ...
    <div className="brands">
      ...
      <div className="container mt-5">
        <div className="row">
          ...
          {location.pathname === "/brands/search" ? (
            <SearchBrandsPrice></SearchBrandsPrice>
          ) : (
